...
- [ ] Bottin.cpp
    ...
    - [x] ``double Bottin::ratioDeCollisionsNomPrenom () const`` ([[Tp3-Enoncer.pdf#page=6&selection=73,0,77,5&color=yellow|Tp3-Enoncer, p.6]])
    ...
    - [x] ``double Bottin::ratioDeCollisionTelephone () const`` ([[Tp3-Enoncer.pdf#page=6&selection=83,0,83,49&color=yellow|Tp3-Enoncer, p.6]])
    ...
    - [x] ``int TP3::Bottin::maximumNbCollisionNomPrenom () const`` ([[Tp3-Enoncer.pdf#page=7&selection=10,0,14,5&color=yellow|Tp3-Enoncer, p.7]])
    ...
    - [x] ``int Bottin::maximumNbCollisionTelephone () const`` ([[Tp3-Enoncer.pdf#page=7&selection=20,0,20,48&color=yellow|Tp3-Enoncer, p.7]])
...
- [x] TableHachage.hpp
    - [x] Modifier le nombre de collisions. Le nombre de collisions doit être remis à 0 avant chaque rechaghage. ([[Tp3-Enoncer.pdf#page=7&selection=36,2,36,93&color=yellow|Tp3-Enoncer, p.7]])
    
    - [x] Modifier le  nombre d’insertions. Le nombre d’insertions doit être remis à 0 avant chaque rehachage ([[Tp3-Enoncer.pdf#page=7&selection=40,2,46,24&color=yellow|Tp3-Enoncer, p.7]])
